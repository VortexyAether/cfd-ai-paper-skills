...
For v0.5 deployment checks, run the trend-review benchmark first, then use `scripts/evaluate_latex_output.py` as a deterministic surface scan before manual rubric scoring.
