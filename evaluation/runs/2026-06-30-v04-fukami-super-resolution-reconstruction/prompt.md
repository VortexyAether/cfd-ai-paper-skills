# Simulated dumb-agent run: Fukami super-resolution reconstruction
...
- Source allowed to dumb agent: title, abstract-level summary, and `references/gold-papers/fukami-2021-spatiotemporal-super-resolution-jfm.md`
