...
You are given only a paper title and abstract. Infer what the full paper probably contains. Do not use external files, tools, package guidance, rubrics, or prior knowledge beyond the abstract. Mark uncertainty clearly.
